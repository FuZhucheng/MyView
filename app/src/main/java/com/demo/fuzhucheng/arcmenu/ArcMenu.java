...
public class ArcMenu extends RelativeLayout {
    private com.demo.fuzhucheng.arcmenu.ArcLayout mArcLayout;
    ...
    private void init(Context context) {
        ...
        mArcLayout = (com.demo.fuzhucheng.arcmenu.ArcLayout) findViewById(R.id.item_layout);
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            float fromDegrees = a.getFloat(R.styleable.ArcLayout_fromDegrees, com.demo.fuzhucheng.arcmenu.ArcLayout
                    .DEFAULT_FROM_DEGREES);
            float toDegrees = a.getFloat(R.styleable.ArcLayout_toDegrees, com.demo.fuzhucheng.arcmenu.ArcLayout
                    .DEFAULT_TO_DEGREES);
            mArcLayout.setArc(fromDegrees, toDegrees);

            int defaultChildSize = mArcLayout.getChildSize();
            int newChildSize = a.getDimensionPixelSize(R.styleable.ArcLayout_childSize,
                    defaultChildSize);
    ...
    private Animation bindItemAnimation(final View child, final boolean isClicked, final long
            duration) {
    ...
    private static Animation createItemDisapperAnimation(final long duration, final boolean
            isClicked) {
        AnimationSet animationSet = new AnimationSet(true);
        animationSet.addAnimation(new ScaleAnimation(1.0f, isClicked ? 2.0f : 0.0f, 1.0f,
                isClicked ? 2.0f : 0.0f,
    ...
    private static Animation createHintSwitchAnimation(final boolean expanded) {
        Animation animation = new RotateAnimation(expanded ? 45 : 0, expanded ? 0 : 45, Animation
                .RELATIVE_TO_SELF,
