...
public class MyCircleMenuLayout extends ViewGroup {
     ...
     * MenuItem的点击事件接口
     */
    private MyCircleMenuLayout.OnMenuItemClickListener mOnMenuItemClickListener;
    ...
    public void setOnMenuItemClickListener(
            MyCircleMenuLayout.OnMenuItemClickListener mOnMenuItemClickListener)
    {
     ...
     * 自动滚动的Runnable
     */
    private MyCircleMenuLayout.AutoFlingRunnable mFlingRunnable;
    ...
    public boolean dispatchTouchEvent(MotionEvent event)
    {
        ...
        switch (event.getAction())
        {
            ...
            case MotionEvent.ACTION_UP:
                ...
                {
                    // post一个任务，去自动滚动
                    post(mFlingRunnable = new MyCircleMenuLayout.AutoFlingRunnable(anglePerSecond));
    ...
    /**
     * 添加菜单项.!!!!!拿到两个数据，算出菜单的个数；然后去遍历，根据我们预设的R.layout.circle_menu_item，把值设上就可以。
     * 要独立出一个布局,的需求是左边是文本右边是图标，用户自己改改布局就行了
     */
